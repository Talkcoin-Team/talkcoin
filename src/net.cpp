...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Talkcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"talkcoin.info", "dnsseed.talkcoin.info"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"talkcoin.info", "testnet-dnsseed.talkcoin.info"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Talkcoin is probably already running."), addrBind.ToString().c_str());
        else
