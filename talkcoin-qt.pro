...
# also add new translations to src/qt/talkcoin.qrc under translations/
...
win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/talkcoin-qt.rc
...
macx:ICON = src/qt/res/icons/talkcoin.icns
